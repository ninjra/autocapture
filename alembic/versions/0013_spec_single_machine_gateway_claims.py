...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            ...
            sa.ForeignKey("answer_records.answer_id", ondelete="CASCADE"),
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "claim_id",
            sa.String(length=128),
            sa.ForeignKey("answer_claims.claim_id", ondelete="CASCADE"),
        ),
        sa.Column(
            "span_id",
            sa.String(length=128),
            sa.ForeignKey("citable_spans.span_id", ondelete="SET NULL"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "query_id",
            sa.String(length=128),
            sa.ForeignKey("query_records.query_id", ondelete="CASCADE"),
        ),
        sa.Column("evidence_id", sa.String(length=32), nullable=False),
        sa.Column(
            "span_id",
    ...
    op.create_table(
        ...
        sa.Column(
            "answer_id",
            sa.String(length=128),
            sa.ForeignKey("answer_records.answer_id", ondelete="SET NULL"),
            nullable=True,
        ),
