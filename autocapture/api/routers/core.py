"""API route definitions for the core HTTP surface."""
...
from ...memory.entities import EntityResolver
...
def build_router(
    ...
    *,
    ...
    memory_service_client = container.memory_service_client
    policy_envelope = container.policy_envelope
    answer_graph = container.answer_graph
    index_pruner = container.index_pruner
    media_store = container.media_store
    memory_compiler = container.memory_compiler
    ...
    @router.get("/api/promptops/latest")
    ...
    @router.post("/api/citations/validate")
    ...
    @router.post("/api/highlights/regenerate")
    ...
    @router.post("/api/privacy/resolve_tokens")
