...
class WorkerSupervisor:
    def __init__(self, config: AppConfig, db_manager: DatabaseManager | None = None) -> None:
        self._config = config
        ...
        self._embed_workers = [
            EmbeddingWorker(config, db_manager=self._db)
    ...
    def start(self) -> None:
        ...
        self._ocr_threads = [
            threading.Thread(
                target=worker.run_forever, kwargs={"stop_event": self._stop_event}, daemon=True
            )
